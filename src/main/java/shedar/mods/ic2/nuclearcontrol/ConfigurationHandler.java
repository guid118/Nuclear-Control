...
public class ConfigurationHandler {
    ...
    private void loadConfiguration() {
        try {
            IC2NuclearControl.instance.alarmRange = configuration.get(Configuration.CATEGORY_GENERAL, "alarmRange", 64)
                    .getInt();
            ...
            IC2NuclearControl.instance.screenRefreshPeriod = configuration
                    .get(Configuration.CATEGORY_GENERAL, "infoPanelRefreshPeriod", 20).getInt();
            IC2NuclearControl.instance.dataRefreshPeriod = configuration.get(
                    Configuration.CATEGORY_GENERAL,
                    "sensorDataRefreshPeriod",
                    4,
                    "can not be longer than infoPanelRefreshPeriod [default: 4]").getInt();
            ...
            IC2NuclearControl.instance.recipes = configuration.getString(
                    ...
                    Configuration.CATEGORY_GENERAL,
                    "normal",
                    "Valid inputs: normal, old or gregtech");
        } catch (Exception e) {
