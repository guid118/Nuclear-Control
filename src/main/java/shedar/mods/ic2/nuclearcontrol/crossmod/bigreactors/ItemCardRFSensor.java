	...
	public CardState update(TileEntity panel, ICardWrapper card, int range)
	{
		...
		if (check instanceof TileEntityBlockFetcher)
		{
			...
			if (!reactorController.isPassivelyCooled())
			{
				...
				{
					card.setString("VaporType", reactorController.getCoolantContainer().getVaporType().getLocalizedName());
				...
				{
					card.setString("CoolantType", new FluidStack(reactorController.getCoolantContainer().getCoolantType(), 1).getLocalizedName());
