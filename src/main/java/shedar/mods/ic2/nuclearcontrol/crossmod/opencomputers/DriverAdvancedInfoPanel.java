...
public class DriverAdvancedInfoPanel extends DriverTileEntity {
    ...
    public static final class Environment extends ManagedTileEntityEnvironment<TileEntityAdvancedInfoPanel>
        ...
        @Callback(
                doc = "function():boolean -- checks if the web upgrade is installed (should be false most of the time)")
        ...
        /*
         * TODO: this is broken
         * @Callback(doc = "function(value:number) -- sets the background color of the panel (0-16)") public Object[]
         * setBackgroundColor(final Context context, final Arguments args){ final int newColor = args.checkInteger(0);
         * if(newColor < 0 || newColor > 16) return null; //invalid input if(newColor ==
         * tileEntity.getColorBackground()) return null; //same as the current background
         * tileEntity.setColorBackground(newColor); return null; }
         */

        @Callback(
                doc = "function(value:number) -- sets the thickness of the panel. Only input 1-16, otherwise nothing will happen")
        ...
        @Callback(
                doc = "function(value:number) -- sets the horizonal rotation of the panel. Only input 1-16, otherwise nothing will happen")
        ...
        @Callback(
                doc = "function(value:number) -- sets the vertical rotation of the panel. Only input 1-16, otherwise nothing will happen")
