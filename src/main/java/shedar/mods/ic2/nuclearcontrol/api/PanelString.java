...
/**
 * Object defines one line of the Information Panel. Each line has contain 3 sections: left, center, right. At least one
 * of them should be not null. Each section can have its own color.
 * 
