...
public interface ICardWrapper {
    ...
    /**
     * Changes the title of the card. Can be used if you want tricky way to change title (not via Information Panel
     * gui).
     * 
     * @param title
     */
    ...
    /**
     * Set the state of card. In most cases shouldn't be called by card, use return value of
    ...
    /**
     * Used to send changed data to nearby players. In most cases shouldn't be called by card.
     * 
     * @param panel
     */
