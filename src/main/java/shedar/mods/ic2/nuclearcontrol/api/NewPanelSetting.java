...
public class NewPanelSetting extends PanelSetting {
    ...
    /**
     * Construct a PanelSetting that has an index instead of a bitmask.
     * Unfortunately the constructor is the same as the deprecated one, since they both use an integer.
     * This problem should be resolved with the removal of the deprecated constructor, in 3.0.0
     *
