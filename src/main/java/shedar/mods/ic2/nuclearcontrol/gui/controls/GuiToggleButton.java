...
public class GuiToggleButton extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        int iconX = 0;
        int iconY = isChecked ? (GuiScrollableList.BUTTON_HEIGHT * 2) : ICON_HEIGHT + (GuiScrollableList.BUTTON_HEIGHT*2);
        drawTexturedModalRect(xPosition + 1, yPosition + 3, iconX, iconY, 16, 14);
