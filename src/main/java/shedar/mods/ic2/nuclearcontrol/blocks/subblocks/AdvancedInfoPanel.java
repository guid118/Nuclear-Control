...
public class AdvancedInfoPanel extends InfoPanel {
    ...
    private static final byte[][] mapping = {
            { I_PANEL_ADV_SIDE, I_COLOR_DEFAULT, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE,
                    I_PANEL_ADV_SIDE },
            { I_COLOR_DEFAULT, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE,
                    I_PANEL_ADV_SIDE },
            { I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_COLOR_DEFAULT, I_PANEL_ADV_SIDE,
                    I_PANEL_ADV_SIDE },
            { I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_COLOR_DEFAULT, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE,
                    I_PANEL_ADV_SIDE },
            { I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE,
                    I_COLOR_DEFAULT },
            { I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_PANEL_ADV_SIDE, I_COLOR_DEFAULT,
                    I_PANEL_ADV_SIDE } };
