...
public class RemoteThermo extends Subblock {
    ...
    private static final byte[][] mapping = { { I_BACK, I_FACE, I_SIDE, I_SIDE, I_SIDE, I_SIDE },
            { I_FACE, I_BACK, I_SIDE, I_SIDE, I_SIDE, I_SIDE }, { I_SIDE, I_SIDE, I_BACK, I_FACE, I_SIDE, I_SIDE },
